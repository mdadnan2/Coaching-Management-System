    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
      <Box>
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 4 }}>
          ...
          <Button variant="contained" startIcon={<Add />} onClick={() => navigate("/syllabusForm")}>
            Add Chapter
          </Button>
        </Box>
        ...
        {chapters.length === 0 ? (
          <EmptyState
            ...
            onAction={() => navigate("/syllabusForm")}
          />
        ) : (
...
export default ModernAddChapter;
